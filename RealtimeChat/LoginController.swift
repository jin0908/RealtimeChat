...
class LoginController: UIViewController {
    ...
    lazy var loginRegisterSegmentedControl: UISegmentedControl = {
       let control = UISegmentedControl(items: ["Login","Register"])
        ...
        control.addTarget(self, action: #selector(handleLoginRegisterChanged), for: .valueChanged)
        return control
    }()
    ...
    override func viewDidLoad() {
        ...
        setupLoginResterSegmentedControl()
    }
    ...
    func setupLoginResterSegmentedControl() {
    ...
    var inputRegisterContainerViewHeightAnchor: NSLayoutConstraint?
    ...
    func setupInputContainerView() {
        ...
        // ***
        inputRegisterContainerViewHeightAnchor = inputContainerView.heightAnchor.constraint(equalToConstant: 150)
        inputRegisterContainerViewHeightAnchor?.isActive = true
